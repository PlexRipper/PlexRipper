...
public class DownloadTaskTvShowEpisodeFileLog : DownloadTaskLogBase
{
    ...
    /// <summary>
    /// Gets the <see cref="DownloadTaskTvShowEpisodeFile"/> this log belongs too
    /// </summary>
    [Column(Order = 5)]
    ...
    /// <summary>
    /// Gets the <see cref="DownloadTaskTvShowSeason"/> this log belongs too
    /// </summary>
    [Column(Order = 7)]
    ...
    /// <summary>
    /// Gets the <see cref="DownloadTaskTvShow"/> this log belongs too
    /// </summary>
    [Column(Order = 8)]
