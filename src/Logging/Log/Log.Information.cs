...
public partial class Log : ILog
{
        ...
        [CallerLineNumber] int sourceLineNumber = default!)
    {
        ...
        return Write(LogEventLevel.Information, messageTemplate, sourceFilePath, memberName, sourceLineNumber);
    }
    ...
    {
        // ReSharper disable once TemplateIsNotCompileTimeConstantProblem
        return Write(LogEventLevel.Information, ex, messageTemplate, sourceFilePath, memberName, sourceLineNumber);
    }
    ...
    {
        // ReSharper disable once TemplateIsNotCompileTimeConstantProblem
        return Write(LogEventLevel.Information, messageTemplate, sourceFilePath, memberName, sourceLineNumber, propertyValue);
    }
    ...
    {
        // ReSharper disable once TemplateIsNotCompileTimeConstantProblem
        return Write(LogEventLevel.Information, messageTemplate, sourceFilePath, memberName, sourceLineNumber, propertyValue0, propertyValue1);
    }
