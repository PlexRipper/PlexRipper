...
public class SonarrIndexerContractDTO
{
    ...
    public List<SonarrIndexerContractFieldDTO>? Fields { get; set; }
    ...
    public SonarrIndexerContractMessageDTO? Message { get; set; }
...
public sealed class SonarrIndexerContractMessageDTO
{
    [JsonPropertyName("message")]
...
public sealed class SonarrIndexerContractFieldDTO
{
    ...
    public List<SonarrIndexerContractSelectOptionDTO>? SelectOptions { get; set; }
...
public sealed class SonarrIndexerContractSelectOptionDTO
{
