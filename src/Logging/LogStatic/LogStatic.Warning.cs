...
public static partial class LogStatic
{
    ...
    public static LogEvent WarningLine(
    ...
    [MessageTemplateFormatMethod("messageTemplate")]
    public static LogEvent Warning<T>(
        string messageTemplate,
    ...
    [MessageTemplateFormatMethod("messageTemplate")]
    public static LogEvent Warning<T0, T1>(
        string messageTemplate,
        T0 propertyValue0,
        T1 propertyValue1,
        [CallerMemberName] string memberName = default!,
    ...
    [MessageTemplateFormatMethod("messageTemplate")]
    public static LogEvent Warning<T0, T1, T2>(
        string messageTemplate,
        T0 propertyValue0,
        T1 propertyValue1,
        T2 propertyValue2,
    ...
    [MessageTemplateFormatMethod("messageTemplate")]
    public static LogEvent Warning<T0, T1, T2, T3>(
        string messageTemplate,
        T0 propertyValue0,
        T1 propertyValue1,
        T2 propertyValue2,
    ...
    [MessageTemplateFormatMethod("messageTemplate")]
    public static LogEvent Warning<T0, T1, T2, T3, T4>(
        string messageTemplate,
        T0 propertyValue0,
        T1 propertyValue1,
        T2 propertyValue2,
    ...
    [MessageTemplateFormatMethod("messageTemplate")]
    public static LogEvent Warning<T0, T1, T2, T3, T4, T5>(
        string messageTemplate,
        T0 propertyValue0,
        T1 propertyValue1,
        T2 propertyValue2,
