...
public class GetTorznabRssFeedCommandUnitTests : BaseCommandUnitTest<GetTorznabRssFeedCommand>
{
    ...
    {
        // Arrange
        await SetupDatabase(7635, config =>
        {
            config.PlexServerCount = 1;
            config.PlexAccountCount = 1;
            config.PlexMovieLibraryCount = 1;
        ...
        result.Value.Channel.Items.All(x => x.Attributes.Any(a => a.Name == "category" && a.Value == category.ToString())).ShouldBeTrue();
    }
    ...
    {
        // Arrange
        await SetupDatabase(7636, config =>
        {
            config.PlexServerCount = 1;
            config.PlexAccountCount = 1;
            config.PlexMovieLibraryCount = 1;
    ...
    {
        // Arrange
        await SetupDatabase(7637, config =>
        {
            config.PlexServerCount = 1;
            config.PlexAccountCount = 1;
            config.PlexMovieLibraryCount = 1;
    ...
    {
        // Arrange
        await SetupDatabase(7638, config =>
        {
            config.PlexServerCount = 1;
            config.PlexAccountCount = 1;
            config.PlexMovieLibraryCount = 1;
    ...
    {
        // Arrange
        await SetupDatabase(7639, config =>
        {
            config.PlexServerCount = 1;
            config.PlexAccountCount = 1;
            config.PlexTvShowLibraryCount = 1;
