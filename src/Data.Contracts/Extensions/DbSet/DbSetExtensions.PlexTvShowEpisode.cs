...
{
    public static IQueryable<PlexTvShowEpisode> IncludeAll(this IQueryable<PlexTvShowEpisode> plexTvShowEpisodes) => plexTvShowEpisodes
        .IncludePlexServer()
        .IncludePlexLibrary()
