    ...
    public partial class AddPlexLibraryAccessHistoryEvents : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateIndex(
                name: "IX_PlexLibraryAccessHistoryEvents_PlexAccountId_CreatedAt",
                table: "PlexLibraryAccessHistoryEvents",
                columns: new[] { "PlexAccountId", "CreatedAt" });

            migrationBuilder.CreateIndex(
                name: "IX_PlexLibraryAccessHistoryEvents_PlexAccountId_PlexLibraryId_CreatedAt",
                table: "PlexLibraryAccessHistoryEvents",
                columns: new[] { "PlexAccountId", "PlexLibraryId", "CreatedAt" });

            migrationBuilder.CreateIndex(
                name: "IX_PlexLibraryAccessHistoryEvents_PlexAccountId_PlexServerId_CreatedAt",
                table: "PlexLibraryAccessHistoryEvents",
                columns: new[] { "PlexAccountId", "PlexServerId", "CreatedAt" });
