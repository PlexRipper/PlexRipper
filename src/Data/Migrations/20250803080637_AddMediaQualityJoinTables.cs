...
namespace PlexRipper.Data.Migrations
{
    ...
    public partial class AddMediaQualityJoinTables : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateIndex(name: "IX_PlexMovieData_Quality", table: "PlexMovieData", column: "Quality");
        ...
        {
            migrationBuilder.DropTable(name: "PlexTvShowMediaQualities");

            migrationBuilder.DropTable(name: "PlexTvShowSeasonMediaQualities");

            migrationBuilder.DropIndex(name: "IX_PlexTvShowEpisodeData_Quality", table: "PlexTvShowEpisodeData");

            migrationBuilder.DropIndex(name: "IX_PlexMovieData_Quality", table: "PlexMovieData");
