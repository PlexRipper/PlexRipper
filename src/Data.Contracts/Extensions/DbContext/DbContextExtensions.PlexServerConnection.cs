...
{
    private static readonly ILogger _log = LogFactory.GetLogger(typeof(DbContextExtensions));
    ...
    /// </summary>
    /// <param name="dbContext"> The <see cref="IReaparrDbContext" /> to retrieve the token from.</param>
