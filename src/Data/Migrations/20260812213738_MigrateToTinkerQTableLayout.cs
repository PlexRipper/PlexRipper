    ...
    public partial class MigrateToTinkerQTableLayout : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_TinkerQ_JobCronTickers", x => x.Id);
                });

            migrationBuilder.CreateTable(
                name: "TinkerQ_JobTimeTickers",
                columns: table => new
                {
                    JobKey = table.Column<string>(type: "TEXT", maxLength: 256, nullable: false),
                    JobType = table.Column<string>(type: "TEXT", unicode: false, maxLength: 100, nullable: false, defaultValue: "None"),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_TinkerQ_JobTimeTickers", x => x.Id);
                    table.ForeignKey(
                        name: "FK_TinkerQ_JobTimeTickers_TinkerQ_JobTimeTickers_ParentId",
                        column: x => x.ParentId,
                        principalTable: "TinkerQ_JobTimeTickers",
                        principalColumn: "Id");
                });

            migrationBuilder.CreateTable(
                name: "TinkerQ_JobCronTickerOccurrences",
                columns: table => new
                {
                    Id = table.Column<Guid>(type: "TEXT", nullable: false),
                    Status = table.Column<int>(type: "INTEGER", nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_TinkerQ_JobCronTickerOccurrences", x => x.Id);
                    table.ForeignKey(
                        name: "FK_TinkerQ_JobCronTickerOccurrences_TinkerQ_JobCronTickers_CronTickerId",
                        column: x => x.CronTickerId,
                        principalTable: "TinkerQ_JobCronTickers",
                        principalColumn: "Id",
            ...
            migrationBuilder.CreateIndex(
                ...
                table: "TinkerQ_JobCronTickerOccurrences",
                column: "CronTickerId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_TinkerQ_JobCronTickers_JobKey",
                table: "TinkerQ_JobCronTickers",
                column: "JobKey");

            migrationBuilder.CreateIndex(
                name: "IX_TinkerQ_JobCronTickers_JobType",
                table: "TinkerQ_JobCronTickers",
                column: "JobType");

            migrationBuilder.CreateIndex(
                name: "IX_TimeTicker_ExecutionTime",
                table: "TinkerQ_JobTimeTickers",
                column: "ExecutionTime");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_TinkerQ_JobTimeTickers_JobKey",
                table: "TinkerQ_JobTimeTickers",
                column: "JobKey");

            migrationBuilder.CreateIndex(
                name: "IX_TinkerQ_JobTimeTickers_JobType",
                table: "TinkerQ_JobTimeTickers",
                column: "JobType");

            migrationBuilder.CreateIndex(
                name: "IX_TinkerQ_JobTimeTickers_ParentId",
                table: "TinkerQ_JobTimeTickers",
                column: "ParentId");
        }
