...
public class ApplyOwnedTvShowComparisonStateCommandUnitTests
    : BaseUnitTest<ApplyOwnedTvShowComparisonStateCommandHandler>
{
    [Test]
    public async Task ShouldMarkPartial_WhenOwnedTvShowHasMatchedRemoteShowWithMoreEpisodes()
    {
        ...
        // Act
        var result = await Sut.ExecuteAsync(new ApplyOwnedTvShowComparisonStateCommand(items, ownedLibrary.Id), CancellationToken);
