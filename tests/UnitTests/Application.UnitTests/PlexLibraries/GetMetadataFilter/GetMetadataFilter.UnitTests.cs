    ...
    : BaseEndpointUnitTest<GetMetadataFilter, GetMetadataFilterRequest, ResultDTO<PlexMediaFilterMetadataDTO>>
{
    ...
    public async Task ShouldReturnSuccess_WhenAllLibraryMode()
    {
        ...
        var request = new GetMetadataFilterRequest { PlexLibraryId = 0, MediaType = PlexMediaType.Movie };
    ...
    public async Task ShouldReturnSuccess_WhenSingleLibraryMode()
    {
        ...
        var request = new GetMetadataFilterRequest { PlexLibraryId = libraryId, MediaType = PlexMediaType.Movie };
