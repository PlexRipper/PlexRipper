...
import AccountValidationButton from '@/components/Buttons/AccountValidationButton.vue'
import AddIconButton from '@/components/Buttons/AddIconButton.vue'
import BaseButton from '@/components/Buttons/BaseButton.vue'
import CancelButton from '@/components/Buttons/CancelButton.vue'
import ConfirmButton from '@/components/Buttons/ConfirmButton.vue'
import DebugButton from '@/components/Buttons/DebugButton.vue'
...
import NavigationFinishSetupButton from '@/components/Buttons/NavigationFinishSetupButton.vue'
import NavigationNextButton from '@/components/Buttons/NavigationNextButton.vue'
import NavigationPreviousButton from '@/components/Buttons/NavigationPreviousButton.vue'
import NavigationSkipSetupButton from '@/components/Buttons/NavigationSkipSetupButton.vue'
import ResetButton from '@/components/Buttons/ResetButton.vue'
import SaveButton from '@/components/Buttons/SaveButton.vue'
import SaveIconButton from '@/components/Buttons/SaveIconButton.vue'
...
Vue.component('AccountValidationButton', AccountValidationButton)
Vue.component('LazyAccountValidationButton', AccountValidationButton)
Vue.component('AddIconButton', AddIconButton)
Vue.component('LazyAddIconButton', AddIconButton)
Vue.component('BaseButton', BaseButton)
Vue.component('LazyBaseButton', BaseButton)
Vue.component('CancelButton', CancelButton)
Vue.component('LazyCancelButton', CancelButton)
Vue.component('ConfirmButton', ConfirmButton)
Vue.component('LazyConfirmButton', ConfirmButton)
Vue.component('DebugButton', DebugButton)
Vue.component('LazyDebugButton', DebugButton)
Vue.component('DeleteButton', DeleteButton)
Vue.component('LazyDeleteButton', DeleteButton)
Vue.component('DeleteIconButton', DeleteIconButton)
Vue.component('LazyDeleteIconButton', DeleteIconButton)
Vue.component('EditIconButton', EditIconButton)
Vue.component('LazyEditIconButton', EditIconButton)
Vue.component('ExternalLinkButton', ExternalLinkButton)
Vue.component('LazyExternalLinkButton', ExternalLinkButton)
Vue.component('GoToButton', GoToButton)
Vue.component('LazyGoToButton', GoToButton)
Vue.component('HideButton', HideButton)
Vue.component('LazyHideButton', HideButton)
Vue.component('NavigationFinishSetupButton', NavigationFinishSetupButton)
Vue.component('LazyNavigationFinishSetupButton', NavigationFinishSetupButton)
Vue.component('NavigationNextButton', NavigationNextButton)
Vue.component('LazyNavigationNextButton', NavigationNextButton)
Vue.component('NavigationPreviousButton', NavigationPreviousButton)
Vue.component('LazyNavigationPreviousButton', NavigationPreviousButton)
Vue.component('NavigationSkipSetupButton', NavigationSkipSetupButton)
Vue.component('LazyNavigationSkipSetupButton', NavigationSkipSetupButton)
Vue.component('ResetButton', ResetButton)
Vue.component('LazyResetButton', ResetButton)
Vue.component('SaveButton', SaveButton)
Vue.component('LazySaveButton', SaveButton)
Vue.component('SaveIconButton', SaveIconButton)
Vue.component('LazySaveIconButton', SaveIconButton)
Vue.component('WarningButton', WarningButton)
Vue.component('LazyWarningButton', WarningButton)
