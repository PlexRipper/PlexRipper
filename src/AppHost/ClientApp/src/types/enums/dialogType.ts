export enum DialogType {
	...
	IntegrationDeleteConfirmationDialog = 'integration-delete-confirmation-dialog',
	IntegrationDialog = 'integration-dialog',
	IntegrationSetupDialog = 'integration-setup-dialog',
