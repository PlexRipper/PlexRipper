...
internal static class SqliteErrorCodes
{
    ...
    public static bool IsRetryableBusy(SqliteException ex) =>
        ex.SqliteErrorCode == Busy && ex.SqliteExtendedErrorCode != BusySnapshot;
    ...
    /// </summary>
    public static bool IsBusySnapshot(SqliteException ex) => ex.SqliteExtendedErrorCode == BusySnapshot;

    /// <summary>
    /// Returns <see langword="true"/> for any SQLITE_BUSY variant (retryable or not).
    /// </summary>
    public static bool IsAnyBusy(SqliteException ex) => ex.SqliteErrorCode == Busy;
    ...
    /// </summary>
    public static bool IsLocked(SqliteException ex) => ex.SqliteErrorCode == Locked;
}
