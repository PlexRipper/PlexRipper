...
{
    /// <summary>
    /// Gets or sets the user-facing name of the Radarr integration.
    /// </summary>
    [Column(Order = 1)]
    ...
    /// <summary>
    /// Gets or sets the API key used to authenticate requests to Radarr.
    /// </summary>
    [Column(Order = 3)]
    public required string RadarrApiKey { get; set; }

    /// <summary>
    /// Gets or sets the API key used by Radarr to authenticate qBittorrent-compatible requests to Reaparr.
    /// </summary>
    [Column(Order = 4)]
    public required string QBittorrentApiKey { get; set; }

    /// <summary>
    /// Gets or sets the API key used by Radarr to authenticate Torznab requests to Reaparr.
    /// </summary>
    [Column(Order = 5)]
    public required string TorznabApiKey { get; set; }

    /// <summary>
    /// Gets or sets the Radarr download category owned by this integration.
    /// </summary>
    [Column(Order = 6)]
    public required string Category { get; set; }

    /// <summary>
    /// Gets or sets the Radarr identifier of the configured Reaparr download client.
    /// </summary>
    [Column(Order = 7)]
    public int? ExternalDownloadClientId { get; set; }

    /// <summary>
    /// Gets or sets the Radarr identifier of the configured Reaparr indexer.
    /// </summary>
    [Column(Order = 8)]
    ...
    /// <summary>
    /// Gets or sets the HTTP status code returned by Radarr during the latest completed connection test.
    /// </summary>
    [Column(Order = 11)]
