...
/// for a single library, setting <see cref="PlexMediaSlimDTO.ComparisonId"/> per item in-place.
...
public record ApplyComparisonStateCommand(List<PlexMediaSlimDTO> Items, int PlexLibraryId, PlexMediaType MediaType)
    : ICommand<Result>;
