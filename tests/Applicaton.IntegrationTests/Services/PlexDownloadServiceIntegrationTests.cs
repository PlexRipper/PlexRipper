...
namespace PlexRipper.Application.IntegrationTests.Services
{
    public class PlexDownloadServiceIntegrationTests
    {
        ...
        public async Task PlexDownloadShouldDownloadEntireFile()
        {
            ...
            //var downloadRequest = await plexDownloadService.CreateDownloadTaskAsync(account.Value.Id, movie);
            //var downloadRequest2 = await plexDownloadService.CreateDownloadTaskAsync(account.Value.Id, movie2);
