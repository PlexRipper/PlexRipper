...
public partial class FakePlexApiData
{
        ...
        Action<PlexApiDataConfig> options = null)
    {
        ...
        return new Faker<Metadata>()
            ...
            .RuleFor(l => l.Genres, f => default)
            .RuleFor(l => l.Roles, f => default)
            .RuleFor(l => l.ViewCount, f => default)
            .RuleFor(l => l.SkipCount, f => default)
            .RuleFor(l => l.LastViewedAt, f => default)
