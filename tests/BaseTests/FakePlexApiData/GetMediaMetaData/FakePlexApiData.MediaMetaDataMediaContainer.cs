...
public partial class FakePlexApiData
{
    ...
    private static readonly Faker<GetMediaMetaDataRole> _getMediaMetaDataRole = new Faker<GetMediaMetaDataRole>()
        .StrictMode(true)
        .RuleFor(x => x.Id, _ => GetUniqueNumber())
        .RuleFor(x => x.Tag, f => f.Movies().ActorName())
    ...
    private static readonly Faker<GetMediaMetaDataGenre> _getMediaMetaDataGenre = new Faker<GetMediaMetaDataGenre>()
        .StrictMode(true)
        .RuleFor(x => x.Id, _ => GetUniqueNumber())
        .RuleFor(x => x.Tag, f => f.PlexMedia().MediaGenre())
        .RuleFor(x => x.Filter, (_, x) => $"genre={x.Id}");

    private static readonly Faker<GetMediaMetaDataCountry> _getMediaMetaDataCountry =
        new Faker<GetMediaMetaDataCountry>()
            .StrictMode(true)
            .RuleFor(x => x.Id, _ => GetUniqueNumber())
            .RuleFor(x => x.Tag, f => f.Address.Country())
