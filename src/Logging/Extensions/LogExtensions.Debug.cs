...
public static partial class LogExtensions
{
    ...
    public static LogMetaData Debug<T0>(
    ...
    public static LogMetaData Debug<T0, T1, T2>(
        ...
        T2 propertyValue2)
    {
        logMetaData.Update(LogEventLevel.Debug, messageTemplate, propertyValue0, propertyValue1, propertyValue2).Write();
        return logMetaData;
    }
    ...
    public static LogMetaData Debug<T0, T1, T2, T3>(
        ...
        T3 propertyValue3)
    {
        logMetaData.Update(LogEventLevel.Debug, messageTemplate, propertyValue0, propertyValue1, propertyValue2, propertyValue3).Write();
        return logMetaData;
    }
}