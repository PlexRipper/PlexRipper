<template>
	<q-section>
		...
		<help-row help-id="help.settings.ui.confirmation-settings.download-movie-confirmation">
			<q-toggle v-model:model-value="settingsStore.confirmationSettings.askDownloadMovieConfirmation" size="lg" />
		</help-row>
		<!--	Ask Download TvShow Confirmation	-->
		<help-row help-id="help.settings.ui.confirmation-settings.download-tvshow-confirmation">
			<q-toggle v-model:model-value="settingsStore.confirmationSettings.askDownloadTvShowConfirmation" size="lg" />
		</help-row>
		<!--	Ask Download Season Confirmation	-->
		<help-row help-id="help.settings.ui.confirmation-settings.download-season-confirmation">
			<q-toggle v-model:model-value="settingsStore.confirmationSettings.askDownloadSeasonConfirmation" size="lg" />
		</help-row>
		<!--	Ask Download Episode Confirmation	-->
		<help-row help-id="help.settings.ui.confirmation-settings.download-episode-confirmation">
			<q-toggle v-model:model-value="settingsStore.confirmationSettings.askDownloadEpisodeConfirmation" size="lg" />
		</help-row>
	</q-section>
</template>
