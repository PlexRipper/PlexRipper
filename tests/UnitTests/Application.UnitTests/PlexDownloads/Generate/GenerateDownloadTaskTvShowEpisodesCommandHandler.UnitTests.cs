    ...
    : BaseCommandUnitTest<GenerateDownloadTaskTvShowEpisodesCommand>
{
    ...
    public async Task ShouldCreateNewDownloadTasks_WhenSomeEpisodesAlreadyHaveDownloadTasks()
    {
        ...
        tvShowDownloadTask.UpdateInitProperty(nameof(tvShowDownloadTask.PlexId), plexTvShow.RatingKey);
        ...
        seasonDownloadTask.UpdateInitProperty(nameof(seasonDownloadTask.PlexId), season.RatingKey);
        ...
        episodeDownloadTask.UpdateInitProperty(nameof(episodeDownloadTask.PlexId), episode.RatingKey);
